    ...
    <div className="max-w-6xl mx-auto p-8 space-y-12">
      ...
      <section className="text-center text-gray-700 px-6">
        ...
        <p className="mt-4 max-w-3xl mx-auto">
          ...
          way people engage with voting and democracy. We empower organizations
          and individuals with tools to participate in the voting process more
          effectively, securely, and transparently.
        </p>
      </section>
      ...
      <section className="text-center text-gray-700 px-6">
        ...
        <p className="mt-4 max-w-3xl mx-auto">
          To become the leading platform for secure, transparent, and inclusive
          voting globally, fostering a stronger connection between citizens and
