...
const DashboardElectionCard = ({ election, setElections }) => {
  ...
  return (
    <Link
      ...
      className="block"
    >
      <div className="w-full bg-white h-fit border-2 border-gray-400 rounded-lg shadow-md p-4 lg:p-6 hover:shadow-lg transition duration-300 flex justify-between lg:items-center flex-col lg:flex-row  gap-4">
