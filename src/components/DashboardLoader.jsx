...
const DashboardLoader = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 flex flex-col gap-4 animate-pulse">
      {/* Header Loader */}
        ...
        <div className="w-full md:w-[70%] space-y-4">
          {Array(3)
            ...
            .map((_, index) => (
              <div
                key={index}
                className="w-full bg-white h-28 border border-gray-200 rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between shadow-lg p-4 gap-2"
              >
